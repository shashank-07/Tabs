...
class HomeFragment : BaseFragment<HomeViewModel, FragmentHomeBinding, MainRepository>() {
    ...
    var userLocation: com.example.tabs.data.responses.Location =
        com.example.tabs.data.responses.Location(0.0, 0.0)
    ...
    fun checkLocal() {
        userPreferences.cluster.asLiveData()
    ...
    private val locationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            Log.d(
                "Debug:",
                "You Current Location is Result : Long: " + lastLocation.longitude + " , Lat: " + lastLocation.latitude
            )
